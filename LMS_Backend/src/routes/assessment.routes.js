...
router.post('/:id/submissions/:submissionId/grade', adminOrTrainer, validate({ params: sub.submissionParam, body: sub.manualGradeSchema }), asyncHandler(sub.manualGradeSubmission));
